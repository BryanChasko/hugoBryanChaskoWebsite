...
- [Project Setup Instructions](agent-instructions-setup.md)
- [CI/CD Instructions](agent-instructions-cicd.md)
...
- For CI/CD and deployment: use `agent-instructions-cicd.md`

See each file for detailed, actionable guidance.
